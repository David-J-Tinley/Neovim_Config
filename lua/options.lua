...
vim.opt.list = true                 -- Show all whitespace characters
vim.opt.listchars:append "space:⋅"  -- Show spaces as a period '.'
vim.opt.listchars:append "eol:↴"    -- Show end of line arrow
--------------------------------------------------------------------------------
